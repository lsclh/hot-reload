...
// | User: 程立弘
// +----------------------------------------------------------------------
// | Date: 2019-02-22 23:42
// +----------------------------------------------------------------------
// | Author: 程立弘 <1019759208@qq.com>
// +----------------------------------------------------------------------
namespace Lsclh\HotReload;
...
class HotReload extends AbstractProcess
{
    ...
    public function run($arg)
    {
        ...
        if (extension_loaded('inotify') && empty($arg['disableInotify'])) {
            ...
            $this->table->create();
            $this->runComparison();
            $HotLoadTime = Config::getInstance()->getConf('HotLoad.time');
            Timer::tick($HotLoadTime, function () {
                $this->runComparison();
            });
...
//
//            echo 'SubPathName: ' .$dirIterator->getSubPathName()  . "\n";
//        }
